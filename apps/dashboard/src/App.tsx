        ...
        <div className="border border-zinc-800 bg-zinc-900/40 rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-4">
            <textarea
              ...
              className="w-full h-32 bg-zinc-950 border border-zinc-700 rounded-xl px-4 py-3 outline-none resize-none focus:border-zinc-500"
            />
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="bg-zinc-800 hover:bg-zinc-700 transition px-5 py-3 rounded-xl font-medium"
              >
                Clear
              </button>
            </div>
